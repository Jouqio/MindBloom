...
function num(text, level = 0) {
  return new Paragraph({
    ...
    spacing: { before: 40, after: 40 },
    children: [
      new TextRun({ text, font: "Arial", size: 21, color: COLORS.slate }),
    ],
  });
}
...
function hr() {
  return new Paragraph({
    ...
    border: {
      bottom: { style: BorderStyle.SINGLE, size: 4, color: "E0DEFF", space: 1 },
    },
    children: [new TextRun("")],
  });
}
              ...
              (c, ci) =>
                new TableCell({
                  ...
                  shading: {
                    ...
                    fill: ri % 2 === 0 ? COLORS.white : COLORS.nearW,
                  },
...
function storyCard(
  ...
  const phaseColors = {
    "Phase 1": COLORS.indigo,
    "Phase 2": COLORS.violet,
    "Phase 3": COLORS.pink,
    "Phase 4": COLORS.amber,
    "Phase 5": COLORS.green,
    "Phase 6": COLORS.slate,
  };
  return [
    new Table({
            ...
            new TableCell({
              borders: {
                top: {
                  ...
                  size: 6,
                  color: pColors[priority] || COLORS.indigo,
                },
                bottom: border,
                left: border,
                right: border,
                ...
                new Paragraph({
                  ...
                  children: [
                    ...
                    new TextRun({
                      ...
                      shading: {
                        type: ShadingType.CLEAR,
                        fill: pColors[priority] || COLORS.indigo,
                      },
                    }),
                    new TextRun({
                      text: `   ${phase}  `,
                      ...
                      shading: {
                        type: ShadingType.CLEAR,
                        fill: phaseColors[phase] || COLORS.slate,
                      },
                    }),
                    new TextRun({
                      text: `   Sprint ${sprint}`,
...
const coverPage = [
  ...
  new Paragraph({
    ...
    children: [
      new TextRun({
        text: "Product Specification & Engineering Backlog",
        font: "Arial",
        size: 36,
        color: COLORS.violet,
      }),
  ...
  new Paragraph({
    ...
    children: [
      new TextRun({
        text: "AI Mental Wellness Platform  •  v2.0  •  2025",
        font: "Arial",
        size: 26,
        italic: true,
        color: COLORS.slate,
  ...
  new Paragraph({
    ...
    children: [
      new TextRun({
        ...
        bold: true,
        color: COLORS.white,
        shading: { type: ShadingType.CLEAR, fill: COLORS.indigo },
      }),
      new TextRun({ text: "   " }),
      new TextRun({
        text: "  Phase 2: Premium  ",
        font: "Arial",
        size: 20,
        bold: true,
        color: COLORS.white,
        shading: { type: ShadingType.CLEAR, fill: COLORS.violet },
      }),
      new TextRun({ text: "   " }),
      new TextRun({
        text: "  Phase 3: AI Coach  ",
        font: "Arial",
        size: 20,
        bold: true,
        color: COLORS.white,
        shading: { type: ShadingType.CLEAR, fill: COLORS.pink },
      }),
    ],
  }),
  new Paragraph({
    ...
    children: [
      new TextRun({
        text: "  Phase 4: Memory Vault  ",
        font: "Arial",
        size: 20,
        bold: true,
        color: COLORS.white,
        shading: { type: ShadingType.CLEAR, fill: COLORS.amber },
      }),
      new TextRun({ text: "   " }),
      new TextRun({
        text: "  Phase 5: Mobile  ",
      ...
      new TextRun({ text: "   " }),
      new TextRun({
        text: "  Phase 6: Monetization  ",
        font: "Arial",
        size: 20,
        bold: true,
        color: COLORS.white,
        shading: { type: ShadingType.CLEAR, fill: COLORS.slate },
      }),
    ],
  }),
  ...spacer(3),
...
const section1 = [
  ...
  p(
    "Membuat refleksi diri menjadi kebiasaan harian yang menyenangkan, terasa personal, dan didukung oleh kecerdasan buatan yang empatik — bukan sekadar aplikasi tulis catatan.",
  ),
  ...spacer(1),
  ...
  bullet(
    "Teknologi AI harus membuat manusia lebih manusiawi, bukan lebih terisolasi.",
  ),
  ...
  table(
    ...
    [
      [
        "Bangun fondasi produk kuat",
        "MAU mencapai 10.000 pengguna",
        "10K MAU",
        "Q2 2025",
      ],
      [
        "Tingkatkan retensi pengguna",
        "Day-30 retention ≥ 40%",
        "40%",
        "Q3 2025",
      ],
      [
        "Validasi AI Coach",
        "AI Coach session/user ≥ 3x/minggu",
        "3 sesi",
        "Q3 2025",
      ],
  ...
  table(
    ...
    [
      [
        "Discovery",
        "Hari 0",
        "Menemukan MindBloom dari referral/ads",
        "😐 Penasaran",
        "Landing page dengan hero yang meyakinkan, social proof, CTA kuat",
        "Click-through rate",
      ],
      [
        "Signup",
        "Hari 0",
        "Daftar via Google/Email, isi onboarding 3 pertanyaan",
        "😊 Antusias",
        "Personalisasi awal, salam dengan nama, animasi selamat datang",
        "Completion rate 80%",
      ],
      [
        "First Journal",
        "Hari 1",
        "Menulis jurnal 15 langkah pertama",
        "😲 Impressed",
        "Guided tour, AI Insight pertama, konfetti simpan jurnal",
        "Day-1 retention",
      ],
      [
        "Discovery Phase",
        "Hari 2–3",
        "Menjelajah Taman, AI Coach, Soundscape",
        "🌟 Excited",
        "Fitur-fitur terungkap bertahap (progressive disclosure)",
        "Feature adoption rate",
      ],
      [
        "Habit Forming",
        "Hari 4–7",
        "Kembali menulis setiap hari, streak 7 hari",
        "🔥 Motivated",
        "Badge 7-hari, notifikasi pengingat, insight mingguan pertama",
        "Day-7 retention",
      ],
      [
        "Deepening",
        "Hari 8–30",
        "Pakai AI Coach, eksplorasi Life Wheel, Habit Tracker",
        "💖 Attached",
        "Memory Room bulan pertama, rekomendasi AI dipersonalisasi",
        "Day-30 retention",
      ],
      [
        "Premium Trigger",
        "Hari 14–30",
        "Menemukan batas fitur free, lihat preview Premium",
        "🤔 Considering",
        "Paywall soft dengan preview value, trial 7 hari gratis",
        "Trial start rate",
      ],
      [
        "Loyal User",
        "Hari 30–90",
        "Upgrade Premium, gunakan hampir setiap hari",
        "✨ Transformed",
        "Insight bulanan, buku kenangan, komunitas beta",
        "Churn rate, LTV",
      ],
      [
        "Advocate",
        "Hari 90+",
        "Refer teman, beri review 5 bintang",
        "🏆 Proud",
        "Referral rewards, badge komunitas, early access fitur baru",
...
const section5 = [
  ...
  table(
    ...
    [
      ...
      [
        "F-019",
        "AI Personalized Insights Daily",
        "Phase 3",
        priorityCell("P1"),
        "High",
        "9/10",
...
const section7 = [
  ...
  ...storyCard(
    "US-003",
    "Menulis Jurnal Harian 15 Langkah",
...
const section8 = [
  ...
  hr(),
  p(
    "ICE Score = Impact × Confidence × Ease. Skala 1–10. Digunakan untuk menentukan urutan pengerjaan.",
  ),
  ...spacer(1),
  table(
    [
  ...
  table(
    ...
    [
      [
        "Sprint 1",
        "Minggu 1–2",
        "Foundation: Auth, Design System, Routing",
        "US-001, US-002, DS setup, DB schema",
        "FE + BE + Infra",
      ],
      [
        "Sprint 2",
        "Minggu 3–4",
        "Core Journal V1: 15 Steps + Mood Slider",
        "US-003, US-004",
        "FE heavy",
      ],
      [
      ...
      [
        "Sprint 4",
        "Minggu 7–8",
        "Soundscape + Emotional Garden V1",
        "US-007, US-008",
        "FE heavy",
      ],
      [
        "Sprint 5",
        "Minggu 9–10",
        "Life Wheel, Habit Tracker, Analytics",
        "US-009, US-010",
        "FE + AI",
      ],
      [
        "Sprint 6",
        "Minggu 11–12",
        "AI Coach V1 (Claude/GPT-4o integration)",
        "US-011 V1",
        "BE + AI",
      ],
      [
        "Sprint 7",
        "Minggu 13–14",
        "AI Coach V2: context-aware, streamed",
        "US-011 V2",
        "BE + AI",
      ],
      [
      ...
      [
        "Sprint 10",
        "Minggu 19–20",
        "Memory Book, PDF Export, Insights",
        "US-013 Full",
        "FE + BE",
      ],
      [
        "Sprint 11",
        "Minggu 21–22",
        "Mobile: React Native Foundation + Auth",
        "US-014 setup",
        "Mobile",
      ],
      [
        "Sprint 12",
        "Minggu 23–24",
        "Mobile: Journal + Mood + Monetization",
        "US-015 + mobile",
        "Mobile + BE",
      ],
      [
        "Sprint 13",
        "Minggu 25–26",
        "Mobile: Push Notif + Offline Sync",
        "US-014 full",
        "Mobile + BE",
      ],
      [
  ...
  table(
    ...
    [
      [
        "M1 — Private Alpha",
        "Feb 2025",
        "Core journal, auth, mood, streak. Deploy ke Vercel.",
        "50 beta testers, Day-7 retention ≥ 40%",
      ],
      [
        "M2 — Closed Beta",
        "Apr 2025",
        "Soundscape, Garden, Life Wheel, Habit Tracker",
        "500 pengguna, 4 jurnal/user/minggu, NPS ≥ 40",
      ],
      [
        "M3 — Public Launch Web",
        "Jun 2025",
        "AI Coach V1, Emotional Engine, Analytics Full",
        "5K MAU, streak avg. ≥ 5 hari, AI Coach 30% weekly users",
      ],
      [
        "M4 — Premium Launch",
        "Aug 2025",
        "Paywall aktif, Midtrans, Memory Vault, PDF Export",
        "500 paying users, MRR Rp 25M, churn ≤ 8%",
      ],
      [
        "M5 — Mobile Beta",
        "Oct 2025",
        "React Native iOS + Android beta, push notif, offline",
        "5K mobile installs, Day-30 mobile retention ≥ 35%",
      ],
      [
        "M6 — Mobile Launch",
        "Dec 2025",
        "Full mobile launch, App Store + Play Store",
        "10K MAU, MRR Rp 100M, App Store rating 4.5+",
      ],
      [
        "M7 — Scale",
        "Mar 2026",
        "B2B klinik, API enterprise, referral program",
        "25K MAU, MRR Rp 200M, NPS ≥ 65",
      ],
    ],
...
const section11 = [
  ...
  table(
    ...
    [
      ...
      [
        "AI",
        "OpenAI GPT-4o API",
        "AI Coach, Emotional Analysis",
        "Streaming via OpenAI SDK",
      ],
      [
        "AI Framework",
        "LangChain.js",
        "Prompt management, RAG, memory",
        "ConversationBufferMemory",
      ],
      [
        "Vector DB",
        "Supabase pgvector",
        "Semantic search jurnal",
        "1536-dim embeddings",
      ],
      ...
      [
        "Payments",
        "Midtrans",
        "Kartu, bank transfer, e-wallet",
        "Webhook untuk status",
      ],
  ...
  table(
    ...
    [
      [
        "users",
        "id, email, name, avatar, created_at, plan",
        "Referenced by all tables",
        "Managed by Supabase Auth",
      ],
      [
        "journal_entries",
        "id, user_id, date, mood_score, energy_score, main_story, stress_text, stress_intensity, happy_text, lesson, self_compassion, tomorrow_intent, affirmations, prayer, created_at",
        "FK: user_id → users",
        "RLS: user sees own only",
      ],
      [
        "mood_logs",
        "id, user_id, date, mood_score, emoji, source",
        "FK: user_id → users",
        "Quick mood tanpa full journal",
      ],
      [
        "emotions",
        "id, entry_id, emotion_tag, category, color",
        "FK: entry_id → journal_entries",
        "Multi per entry",
      ],
      [
        "gratitude_items",
        "id, entry_id, text, order",
        "FK: entry_id → journal_entries",
        "Min 3 per entry",
      ],
      [
      ...
      [
        "emotion_analysis",
        "id, entry_id, stress_score, anxiety_score, gratitude_score, burnout_score, optimism_score, overthinking_score, ai_insight_text",
        "FK: entry_id → journal_entries",
        "Generated async by AI",
      ],
      [
        "coach_sessions",
        "id, user_id, entry_id, messages (JSONB), created_at",
        "FK: user_id, entry_id",
        "Full chat history",
      ],
      [
        "life_wheel_entries",
        "id, user_id, scores (JSONB), ai_analysis, created_at",
        "FK: user_id → users",
        "Monthly snapshots",
      ],
      [
        "memory_books",
        "id, user_id, month, year, highlights (JSONB), narrative, created_at",
        "FK: user_id → users",
        "Auto-generated",
      ],
      [
        "subscriptions",
        "id, user_id, plan, status, midtrans_token, started_at, expires_at",
        "FK: user_id → users",
        "Free / Premium / Pro",
      ],
    ],
  ...
  table(
    ...
    [
      ...
      [
        "Core Journal (US-003)",
        "Auth, users table",
        "Mood Calendar, Streak, AI Coach",
      ],
      ["Mood Slider (US-004)", "Core Journal", "Mood Calendar, EI Engine"],
      [
        "Streak (US-005)",
        "Core Journal, streaks table, DB trigger",
        "Achievement Badges",
      ],
      [
        "AI Coach (US-011)",
        "Core Journal, OpenAI API, coach_sessions table",
        "Memory Book AI narration",
      ],
      [
        "EI Engine (US-012)",
        "Core Journal, OpenAI API, emotion_analysis table",
        "Analytics, Habit Correlation",
      ],
      [
        "Habit Tracker (US-010)",
        "Auth, habits + habit_logs tables",
        "AI Habit Correlation",
      ],
      [
        "Memory Book (US-013)",
        "AI Coach, EI Engine, journal_entries",
        "PDF Export",
      ],
      [
        "Payment (US-015)",
        "Subscriptions table, Midtrans API",
        "Premium feature unlock",
      ],
      [
        "Mobile App (US-014)",
        "Web API endpoints stable, Supabase, FCM/APNs",
...
const section12 = [
  ...
  table(
    ...
    [
      [
        "R-001",
        "Pengguna tidak konsisten menulis jurnal (churn tinggi)",
        "High",
        "High",
        { text: "9/10", color: COLORS.red, bold: true },
        "Notifikasi pintar, streak gamification, progressive onboarding, AI yang mempersuasi tanpa memaksa",
      ],
      [
        "R-002",
        "OpenAI API cost meledak seiring pertumbuhan user",
        "Medium",
        "High",
        { text: "7/10", color: COLORS.amber, bold: true },
        "Rate limiting, caching semantic, lazy AI processing (async, bukan real-time), monitor cost per user",
      ],
      [
        "R-003",
        "Pengguna merasa AI Coach tidak cukup empatik",
        "Medium",
        "High",
        { text: "7/10", color: COLORS.amber, bold: true },
        "Extensive prompt engineering, user testing, fallback ke pertanyaan reflektif sederhana jika konteks terbatas",
      ],
      [
        "R-004",
        "Data privasi pengguna bocor (jurnal sangat sensitif)",
        "Low",
        "Critical",
        { text: "8/10", color: COLORS.red, bold: true },
        "RLS di semua tabel, enkripsi at-rest, tidak kirim PII ke AI API, GDPR/PDPA compliant, audit reguler",
      ],
      [
        "R-005",
        "Persaingan dari pemain besar (Calm, Headspace masuk journaling)",
        "Medium",
        "Medium",
        { text: "6/10", color: COLORS.amber, bold: true },
        "Fokus pada niche Indonesia + bahasa lokal, AI yang lebih personal, harga kompetitif, komunitas",
      ],
      [
        "R-006",
        "Kompleksitas Emotional Garden memperlambat pengembangan",
        "High",
        "Medium",
        { text: "6/10", color: COLORS.amber, bold: true },
        "Ship versi sederhana (SVG statis) dulu, iterasi ke animasi kompleks di v2",
      ],
      [
        "R-007",
        "App Store rejection untuk aplikasi kesehatan mental",
        "Low",
        "High",
        { text: "5/10", color: COLORS.amber, bold: true },
        "Tambahkan disclaimer 'bukan pengganti profesional', follow App Store guidelines untuk health apps",
      ],
      [
        "R-008",
        "Mobile sync conflict saat offline mode",
        "Medium",
        "Medium",
        { text: "5/10", color: COLORS.amber, bold: true },
        "Last-write-wins strategy, conflict resolution UI, optimistic updates dengan rollback",
      ],
      [
        "R-009",
        "Tim tidak cukup untuk deliver semua epics tepat waktu",
        "High",
        "High",
        { text: "8/10", color: COLORS.red, bold: true },
        "Prioritisasi ketat P0 dulu, scope creep prevention, review sprint velocity setiap 2 minggu",
      ],
      [
        "R-010",
        "Monetisasi terlambat membuat cashflow negatif",
        "Medium",
        "High",
        { text: "7/10", color: COLORS.amber, bold: true },
        "Launch Premium di M4 (bukan M6), pre-sell lifetime plan, seek investor/grant di M3",
      ],
    ],
  ...
  table(
    ...
    [
      ...
      [
        ...
        "/api/journals",
        "Required",
        "List jurnal milik user (pagination)",
      ...
      [
        ...
        "Required",
        "AI insight hari ini",
        "{ insight: string, scores: EIScores }",
      ],
      [
        "GET",
        "/api/analytics/weekly",
        "Required",
        "Data analitik 7 hari",
        "{ mood[], stress[], energy[] }",
      ],
      [
        "GET",
...
const closing = [
  ...
  num(
    "Lulus QA testing di Chrome, Safari, Firefox (web); iOS 16+, Android 12+ (mobile).",
  ),
  ...
  bullet(
    "Daily Standup: Setiap hari kerja, 15 menit, async di Slack jika remote.",
  ),
  bullet("Sprint Review: Jumat akhir sprint, demo ke stakeholder."),
  bullet("Retrospective: Jumat akhir sprint, 1 jam."),
  bullet(
    "Branching: main (production) → develop → feature/US-XXX → hotfix/XXX.",
  ),
  bullet(
    "PR description wajib include: link story, screenshot/video, testing steps.",
  ),
  bullet(
    "Estimasi: Story points Fibonacci (1, 2, 3, 5, 8, 13). Max 8 per story.",
  ),
  ...
  new Paragraph({
    ...
    children: [
      new TextRun({
        text: "Product Specification v2.0 · Confidential · May 2025",
        font: "Arial",
        size: 18,
        italic: true,
        color: COLORS.slate,
        ...
        default: new Header({
          children: [
            new Paragraph({
              ...
              children: [
                new TextRun({
                  text: "🌱 MindBloom — Product Specification & Engineering Backlog  v2.0",
                  font: "Arial",
                  size: 18,
                  color: COLORS.indigo,
                }),
...
Packer.toBuffer(doc)
  .then((buf) => {
    fs.writeFileSync(
      "/mnt/user-data/outputs/MindBloom_Product_Spec_v2.docx",
      buf,
    );
