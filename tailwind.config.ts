...
const config: Config = {
  ...
  theme: {
    ...
    fontFamily: {
      ...
      mono:  ['var(--font-mono)', 'ui-monospace', 'SF Mono', 'Fira Code', 'monospace'],
    ...
    extend: {
      ...
      colors: {
        ...
        amber: {
          ...
          400: '#EF9F27', 600: '#BA7517', 800: '#854F0B', 900: '#412402',
        },
        red: {
          50: '#FCEBEB', 100: '#F7C1C1', 200: '#F09595',
          400: '#E24B4A', 600: '#A32D2D', 800: '#791F1F', 900: '#501313',
        },
        gray: {
      ...
      // ── Font Size ────────────────────────────────────────────
      fontSize: {
        'display': ['1.5rem',    { lineHeight: '1.25', letterSpacing: '-0.01em', fontWeight: '500' }],
        'h1':      ['1.25rem',   { lineHeight: '1.3',  letterSpacing: '-0.01em', fontWeight: '500' }],
        'h2':      ['1.125rem',  { lineHeight: '1.35', letterSpacing: '-0.005em', fontWeight: '500' }],
      ...
      backgroundImage: {
        ...
        'gradient-surface': 'linear-gradient(180deg, var(--color-background-primary) 0%, var(--color-background-secondary) 100%)',
      },
    },
  },
  plugins: [
